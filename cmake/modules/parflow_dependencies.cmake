...
function(target_link_parflow_dependencies parflow_target)
  ...
  if (EXISTS ${PARFLOW_SILO_DIR})
    find_library(SILO_LIB NAMES siloh5 siloxx silo PATHS ${PARFLOW_SILO_DIR} PATH_SUFFIXES lib lib64)
    if (SILO_LIB)
      set(SILO_FOUND TRUE CACHE BOOL "SILO library found" FORCE)
      ...
      set(SILO_FOUND FALSE CACHE BOOL "SILO library NOT found" FORCE)
      message(WARNING "SILO library not found under PARFLOW_SILO_DIR=${PARFLOW_SILO_DIR}")
    endif()
  else()
